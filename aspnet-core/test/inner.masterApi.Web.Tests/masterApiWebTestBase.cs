...
{
    public abstract class masterApiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static masterApiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(masterApiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<masterApiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<masterApiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<masterApiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<masterApiDbContext, Task<T>> func)
        {
            T result;
