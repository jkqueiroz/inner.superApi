...
namespace inner.masterApi.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly masterApiDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = masterApiConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(masterApiDbContext context)
        {
            _context = context;
        }
